package com.sparkstreaming.TweetAnalysis
...
object SaveTweets {
  ...
  def main(args: Array[String]) {
    ...
    val EngTweets = tweets.filter(_.getLang == "en")
    ...
    statuses.foreachRDD((rdd, time) => {
      ...
      if (rdd.count() > 0) {
        ...
        repartitionedRDD.saveAsTextFile("C:/SampleTweets/Tweets_" + time.milliseconds.toString)
